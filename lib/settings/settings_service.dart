...
class SettingsService {
  ...
  void setCurrentNotificationsFlag(bool value) => _preferences.setBool(CURRENT_NOTIFICATIONS_ON_KEY, value);

  bool getCurrentNotificationsFlag() =>
      _preferences.getBool(CURRENT_NOTIFICATIONS_ON_KEY) ?? DEFAULT_CURRENT_NOTIFICATIONS_ON;

  void setManualAveragesFlag(bool value) => _preferences.setBool(USE_MANUAL_AVERAGES_KEY, value);

  bool getManualAveragesFlag() => _preferences.getBool(USE_MANUAL_AVERAGES_KEY) ?? DEFAULT_MANUAL_AVERAGES;

  void setPeriod(int value) => _preferences.setInt(AVERAGE_PERIOD_KEY, value);

  int getPeriod() => _preferences.getInt(AVERAGE_PERIOD_KEY) ?? DEFAULT_AVERAGE_PERIOD_LENGTH;

  void setTemperature(double value) => _preferences.setDouble(AVERAGE_TEMPERATURE_KEY, value);

  double getTemperature() => _preferences.getDouble(AVERAGE_TEMPERATURE_KEY) ?? DEFAULT_AVERAGE_TEMPERATURE;

  void setBirthControl(bool value) => _preferences.setBool(BIRTH_CONTROL_KEY, value);

  bool getBirthControl() => _preferences.getBool(BIRTH_CONTROL_KEY) ?? DEFAULT_BIRTH_CONTROL;

  void setCycle(int value) => _preferences.setInt(AVERAGE_CYCLE_KEY, value);

  int getCycle() => _preferences.getInt(AVERAGE_CYCLE_KEY) ?? DEFAULT_AVERAGE_CYCLE_LENGTH;
  ...
  TimeOfDay getNotificationTime() {
    int hour = _preferences.getInt(NOTIFICATION_HOUR_KEY) ?? DEFAULT_NOTIFICATION_HOUR;
